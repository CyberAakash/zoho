...
{{< cards >}}
  ...
  {{< card link="channel-license-handler" title="IM Channel License Handler" icon="cog" subtitle="Complete lifecycle guide — channel statuses, plan tier limits, upgrade/downgrade flows, department enable/disable scenarios." >}}
{{< /cards >}}
